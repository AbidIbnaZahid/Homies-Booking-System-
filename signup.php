            ...
            <div class="card-body">
              <form action="signup_post.php" method="POST">
                ...
                <div class=" mt-3">
                  ...
                  <input type="eamil" placeholder="Enter your Email Address" class="form-control" name="email">
                  <small class="text-danger">
                    <?php
                ...
                <div class=" mt-3">
                  ...
                  <a href="login.php" class="btn btn-success" style="margin-left: 150px;">Log In</a>
                </div>
              </form>
            </div>
          </div>
